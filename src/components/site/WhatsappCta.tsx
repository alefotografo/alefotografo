...
export function WhatsappCta() {
  const href = `https://wa.me/${site.whatsapp}?text=${encodeURIComponent(
    "Olá Alexandre, gostaria de um orçamento de fotografia corporativa.",
  )}`;
  return (
    <a
      href={href}
      ...
      className="fixed bottom-4 right-4 z-50 inline-flex h-12 min-w-12 items-center justify-center gap-2 rounded-full bg-[#25D366] px-4 text-sm font-medium text-white shadow-lg shadow-black/40 transition-transform hover:scale-105 md:bottom-7 md:right-7"
    >
