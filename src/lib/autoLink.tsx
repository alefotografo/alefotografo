...
function phrasesFor(c: Category): string[] {
  ...
  const extras: Record<string, string[]> = {
    ...
    "fotografo-de-retratos-profissionais": ["retratos profissionais", "headshot"],
    "eventos-corporativos": ["evento empresarial", "eventos empresariais"],
    ...
    "fotografia-industrial": ["fotografia industrial", "indústria"],
