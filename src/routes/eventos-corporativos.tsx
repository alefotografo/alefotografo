...
const DESCRIPTION =
  "Registro de pessoas em eventos de empresa em São Paulo: retratos no local, fotos de equipe, palestrantes e homenageados, com direção de pose e prévia no mesmo dia quando prevista no escopo. Orçamento em até 1 dia útil.";
...
const cfg: ServicePageConfig = {
  ...
  answerBlock:
    "Fotografia de evento corporativo é a cobertura de convenções, premiações, palestras e confraternizações de empresa, com retratos de convidados e fotos de equipe durante o evento. É indicada para empresas, agências e organizadores em São Paulo. Dirijo a cobertura, realizada por mim e/ou pela minha equipe conforme o escopo, e entrego a seleção das melhores imagens no mesmo dia quando prevista no escopo.",
  formats: [
  ...
  ondeUsar: [
    "Redes sociais e publicação no mesmo dia",
  ...
  comoFunciona: [
    ...
    { h: "4. Prévia rápida", p: "Seleção de imagens liberada no mesmo dia para publicação rápida, quando prevista no escopo." },
  ...
  faqs: [
    ...
    { q: "Consigo fotos no mesmo dia?", a: "Sim. Uma prévia tratada pode ser liberada durante ou logo após o evento para publicação rápida." },
    { q: "Em quanto tempo recebo o material completo?", a: "O prazo é definido conforme duração e escopo do evento, informado no orçamento." },
