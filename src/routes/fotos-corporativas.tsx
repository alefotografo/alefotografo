...
const TITLE = "Fotos Corporativas em São Paulo";
const DESCRIPTION =
  "Fotos corporativas em São Paulo com 30 anos de experiência: retratos profissionais, fotos de equipe, escritório, eventos e produtos. Entrega em 1 a 3 dias úteis.";
