      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            url: `https://alefotografo.com.br/portfolio/${params.slug}`,
    ...
    <>
      <section className="border-b border-border">
        <div className="mx-auto max-w-7xl px-5 py-14 md:px-8 md:py-20">
          <Link to="/portfolio" className="mb-8 inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground">
