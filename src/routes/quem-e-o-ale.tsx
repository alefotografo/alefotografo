...
export const Route = createFileRoute("/quem-e-o-ale")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: `${SITE_ORIGIN}/quem-e-o-ale` }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Fotógrafo profissional em São Paulo com mais de 30 anos de experiência em retratos corporativos, eventos, fotografia industrial e vídeo institucional.",
          image: PORTRAIT,
